...
$.datepicker._clearDatepicker = function(input, duration) {
    var inst = this._curInst;
    var showTime = this._get(inst, 'showTime');
...
Timepicker.prototype = {
    ...
    _generateHtml: function ()
    {
		...
		html += '<button class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="$.datepicker._hideDatepicker();" type="button">Done</button>';
		html += '<button class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="$.datepicker._clearDatepicker();" type="button">Clear date</button>';
		html += '</div>';
